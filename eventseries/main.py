...
from eventseries.matcher.nlp_matcher import NlpMatcher
from eventseries.parsers.event_extractor import EventExtractor
from eventseries.matcher.wikidata_matcher import Matcher
from eventseries.util.record_attributes import TITLE, LABEL, CEUR_WS_TITLE, DBLP_EVENT_ID
...
if __name__ == '__main__':
    ...
    utility = Utility()
    with (resources.files('eventseries.resources') / "events_with_ordinal.json").open("w", encoding="utf-8") as final:
    ...
    with (resources.files('eventseries.resources') / "events_without_matches.json").open("w",
                                                                                         encoding="utf-8") as final:
