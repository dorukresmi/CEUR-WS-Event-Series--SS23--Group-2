...
from eventseries.import2Neo4j.neo_4j_connection import Neo4jConnection
from eventseries.import2Neo4j.Neo4jDriver import Driver
...
class ImportData:
    def fetch_data_and_import(self):
        ...
        # events = (resources.files('eventseries.resources') / "events_with_ordinal.json")
        query_string = '''
    ...
    def new_func_series(self):
        data = json.load((resources.files('eventseries.resources') / "event_series_flattened.json").open('r'))
        return data
