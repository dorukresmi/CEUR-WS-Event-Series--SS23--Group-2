...
from eventseries.src.main.dblp import DblpParsing
...
from eventseries.src.main.util.record_attributes import DBLP_EVENT_ID
...
class DblpMatcher:
    ...
    def retrieve_dblp_matches(self, wikidata_events_with_dblp_event_id):
        ...
        wikidata_events_from_dblp = self.extract_ceur_ws_events_from_dblp(dblp_matches,
                                                                          wikidata_events_with_dblp_event_id)
        self.nlp_matcher = NlpMatcher(wikidata_events_from_dblp)
        self.nlp_matcher.match()

    def extract_ceur_ws_events_from_dblp(self, dblp_matches: List[EventSeries], wikidata_events_with_dblp_event_id):
        '''
    ...
    def load_event_series(self, path) -> List[
        EventSeries]:
